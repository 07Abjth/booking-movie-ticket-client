  ...
  return (
    <div className="home-container text-center p-8">
      ...
      <div className="cta-buttons mt-6">
        <button className="bg-blue-500 text-white py-2 px-4 rounded mr-4 hover:bg-blue-600 transition">
          Explore Movies
        </button>
        <button onClick={()=>{}} className="bg-green-500 text-white py-2 px-4 rounded hover:bg-green-600 transition">
          Book Tickets
        </button>
      </div>
      <br />
